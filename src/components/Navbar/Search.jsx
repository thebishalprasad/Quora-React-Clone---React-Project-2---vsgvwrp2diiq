...
const Search = ({ theme, searchResults, setSearchResults }) => {
    ...
    return (
        <div style={searchBoxStyle}>
            <div className='flex items-center px-2 border border-[#DEE0E1] h-5 lg:h-8  w-60 lg:w-[380px] rounded-md '>
                <div className='flex gap-1 ml-2 items-center'>
                    ...
                    <input
                        ...
                        className='bg-transparent focus:outline-none w-60 lg:w-[320px] text-gray-600 font-light text-base lg:text-base'
                        value={searchQuery}
